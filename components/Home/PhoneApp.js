...
function PhoneApp() {
  ...
  return (
    ...
    <div className='text-black flex seconde:flex-row seconde:gap-0 gap-28 flex-col  justify-center'>
          ...
          />
          <input
            className={`h-14w-full transition-all pl-12 md:pr-20 appearance-none  rounded-full py-1 md:text-lg text-md focus:outline-none bg-[#d9d9d927] border-gray-200 text-black focus:bg-[#d9d9d941] placeholder:text-gray-400 hover:bg-[#d9d9d941] focus:border-none`}
            id="inline-full-name"
            type="email"
        ...
        <motion.div variants={childrenVariantsR} initial="hidden" whileInView="shown" className='flex md:justify-around px-3'>
