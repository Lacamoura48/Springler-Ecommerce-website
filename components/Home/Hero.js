...
function Hero() {
  return (
    <section className='min-h-screen bg-[url(/images/background.jpg)] bg-cover bg-no-repeat bg-center relative z-10 flex items-center px-36'>
        ...
        <div className='z-10 flex justify-around w-full h-[650px] items-center'>
            <div>
                ...
                <button className=" hover:bg-[#d9d9d948] text-white py-3 px-6 rounded-full text-[20px] border-[0.5px]">View plants</button>
            </div>
            <HeroDiaporama />
        </div>
    </section>
