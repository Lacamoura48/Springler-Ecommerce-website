...
function WhyPlants() {
  return (
    <section className='bg-[#6B7165] px-56 pb-16 relative overflow-hidden'>
            <img src="images/plant_svg.svg"  className='absolute -right-60 -bottom-60 w-1/2 opacity-20' alt="" />
        ...
        <p className='w-1/2 text-[18px] leading-10 text-gray-200 font-serif'>When you feel down, it’s amazing what a walk in the park can do. That’s because when we get in touch with nature, we improve our wellbeing. Studies show time spent outside in green spaces can reduce our mental fatigue, increase our relaxation, and even improve our cognition. Not only do indoor plants enhance the overall appearance of a space, but studies show they boost moods, increase creativity, reduce stress, and eliminate air pollutants—making for a healthier, happier you.</p>
