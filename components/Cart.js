...
function Cart({setShow}) {
  ...
  return (
    <motion.div variants={animeParent} initial="hidden" animate="shown" exit="exit"  className="fixed z-50 text-black bg-white top-0 right-0 w-1/3 min-h-screen shadow-lg pt-5 px-10">
          ...
          <div  className='text-black flex flex-col w-full pt-10'>
